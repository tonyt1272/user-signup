...
##-------------
    ...
    if len(user_name)<3 and len(user_name)>=1:
        error_list[0] = "Username too short, must be between 3 and 20 characters"
        # error_list[4] = ""
        # user_name='None'
        form_error=True

    if len(user_name)>20:
        error_list[0] = "Username too long, must be between 3 and 20 characters"
        # error_list[4] = ""
        # user_name='None'
        form_error=True
    ##-----------------
    ...
    if len(pass_word)<3 and len(pass_word)>=1:
        error_list[1] = "Password too short, must be between 3 and 20 characters"
        form_error=True

    if len(pass_word)>20:
        error_list[1] = "Password too long, must be between 3 and 20 characters"
        form_error=True
